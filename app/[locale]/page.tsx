  ...
  return (
    <>
      ...
      <section className="weekly shell">
        ...
        <div className="weekly-image"><Image src="/images/generated/ramen.webp" alt="Japanese regional ramen" fill className="cover" sizes="(max-width:700px) 50vw, 33vw"/></div>
        <div className="weekly-image"><Image src="/images/generated/bibimbap.webp" alt="Korean bibimbap" fill className="cover" sizes="(max-width:700px) 50vw, 33vw"/></div>
      </section>
        ...
        <div className="shell">
          ...
          <div className="how-brand-panel">
            ...
            <div className="how-brand-image">
              <Image src="/images/generated/pasta.webp" alt="MOGU24 frozen food serving idea" fill className="cover" sizes="(max-width:700px) 100vw, 42vw"/>
